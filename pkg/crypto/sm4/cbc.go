...
// CBCEncryptText 使用SM4 CBC模式加密文本
// key: 16字节密钥
// text: 明文文本
// 返回加密后的字节切片和错误信息
...
// CBCDecryptText 使用SM4 CBC模式解密文本
// key: 16字节密钥
// ciphertext: 密文字节切片（包含IV）
// 返回解密后的文本和错误信息
...
// CBCEncryptFile 使用SM4 CBC模式加密文件
// key: 16字节密钥
// inputFile: 输入文件路径
// outputFile: 输出文件路径
// error: 错误信息
...
// CBCDecryptFile 使用SM4 CBC模式解密文件
// key: 16字节密钥
// inputFile: 输入文件路径
// outputFile: 输出文件路径
// error: 错误信息
