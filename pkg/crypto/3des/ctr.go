...
// CTREncryptText 使用3DES CTR模式加密文本
// key: 24字节的密钥
// text: 明文文本
// 返回加密后的字节切片和错误信息
...
// CTRDecryptText 使用3DES CTR模式解密文本
// key: 24字节的密钥
// ciphertext: 密文字节切片（包含IV）
// 返回解密后的文本和错误信息
...
// CTREncryptFile 使用3des ctr模式加密文件
// key: 24字节密钥
// inputFile: 输入文件路径
// outputFile: 输出文件路径
// error: 错误信息
...
// CTRDecryptFile 使用3des ctr模式解密文件
// key: 24字节密钥
// inputFile: 输入文件路径
// outputFile: 输出文件路径
// error: 错误信息
