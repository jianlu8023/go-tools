...
func TestCompressAndDecompress(t *testing.T) {
	// 测试数据
	testData := []byte("Hello, this is a test for gzip compression!")
...
func TestCompressFileAndDecompressFile(t *testing.T) {
	// 创建临时目录
	tempDir, err := os.MkdirTemp("", "gzip-test")
	if err != nil {
	...
	testContent := []byte("This is a test file content for gzip compression and decompression")
